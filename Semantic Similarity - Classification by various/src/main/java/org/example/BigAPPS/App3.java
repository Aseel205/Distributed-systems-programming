...
public class App3 {
    ...
    public static void main(String[] args) {
        ...
        String inputPath = "s3://aseelhamzahw3/outputs/combined2/"; // Directory containing all 97 files
        String outputPath = "s3://aseelhamzahw3/outputs/combined3"; // Combined output path
        ...
        RunJobFlowRequest runFlowRequest = new RunJobFlowRequest()
                .withName("Assignment 3 - step 3 withOutCombiner")
