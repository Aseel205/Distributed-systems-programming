...
public class SmallApp2 {
    ...
    public static void main(String[] args) {
        ...
        String outputPath = "s3://aseelhamzahw3/smallOuputs/combined2"  ; // Unique output path for each file

        HadoopJarStepConfig step = new HadoopJarStepConfig()
                .withJar("s3://aseelhamzahw3/jars/step2.jar")
                .withMainClass("Step2")
        ...
        RunJobFlowRequest runFlowRequest = new RunJobFlowRequest()
                .withName("Assignment 3 - step2 SmallInput  with combiner")
